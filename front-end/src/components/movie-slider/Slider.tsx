...
const Slider = (props: SliderProps) => {
    ...
    const handleClick = (increment: number) => {
        ...
        if (sliderIndex + increment < props.sliderElements.length / parseInt(itemsPerScreen)
        ...
        <div className="container">
            ...
            <div className="slider-container">
                <ButtonHandle onClick={() => handleClick(-1)}
                              ...
                              direction='&#8249;'/>
                <SliderTape movies={props.sliderElements} sliderIndex={sliderIndex}/>
                <ButtonHandle onClick={() => handleClick(1)}
